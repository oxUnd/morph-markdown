...
data class MorphMarkdownTheme(
	...
	val tableCellLineHeightMultiplier: Float = 1.25f,
	val tableCellLineSpacingDp: Int = 0,
	val tableMathTextScale: Float = 1.0f,
...
object MorphMarkdownThemes {
	...
	val HetiLike = Normal.copy(
		...
		tableCellLineHeightMultiplier = 1.35f,
		tableCellLineSpacingDp = 0,
		tableMathTextScale = 1.0f,
