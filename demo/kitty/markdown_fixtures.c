...
const char *const morph_demo_chunks[] = {
	...
	"Emergency wrap check: ",
	"12345678901234567890123456789012345678901234567890123456789012345678901234567890",
	" should wrap instead of clipping. Long inline code stays unbreakable: ",
	...
	"它支持 Android/iOS/Kitty、MathJax-C、GFM table 和 task list。中文与 English、",
...
const size_t morph_demo_chunk_count =
	sizeof(morph_demo_chunks) / sizeof(morph_demo_chunks[0]);
