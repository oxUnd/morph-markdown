...
object MarkdownFixtures {
	fun create(validUri: String, invalidUri: String): List<String> {
		return listOf(
			...
			"| tall aligned formula | \$\\left\\{\\begin{aligned} f(x)&=ax^2+bx+c \\\\ f'(x)&=2ax+b \\\\ \\int_0^1 f(x)\\,dx&=\\frac{a}{3}+\\frac{b}{2}+c \\end{aligned}\\right.\$ |\n",
			...
			"| 表格内三行公式 | \$\\left\\{\\begin{aligned} y_1&=\\sin x+\\cos x \\\\ y_2&=\\sum_{k=1}^{n} k^2 \\\\ y_3&=\\frac{\\partial^2 u}{\\partial x^2}+\\frac{\\partial^2 u}{\\partial y^2} \\end{aligned}\\right.\$ |\n",
